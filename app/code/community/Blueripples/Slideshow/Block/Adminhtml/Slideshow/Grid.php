    ...
    class Blueripples_Slideshow_Block_Adminhtml_Slideshow_Grid extends Mage_Adminhtml_Block_Widget_Grid
    {
        ...
        protected function _prepareColumns()
        {
            ...
            $this->addColumn('title', array(
                'header'    => Mage::helper('slideshow')->__('Slide Title'),
                'align'     =>'left',
                'index'     => 'title',
            ));
		   ...
		   if (!Mage::app()->isSingleStoreMode()) {
            ...
            $this->addColumn('status', array(
                ...
                'header'    => Mage::helper('slideshow')->__('Slide Status'),
                'align'     => 'left',
                'width'     => '80px',
                'index'     => 'status',
                'type'      => 'options',
